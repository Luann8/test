                      ...
                      <div className="bg-black px-4 py-6 sm:px-6">
                        <div className="flex items-center justify-between">
                          <Dialog.Title className="text-base font-semibold leading-6 text-white">
                            Chat com a Llama2 para licenças ambientais
                          </Dialog.Title>
                          <div className="ml-3 flex h-7 items-center">
                          <button
  type="button"
  className="rounded-md bg-black text-white hover:bg-white-100 hover:text-white focus:outline-none focus:ring-0 p-2 flex items-center justify-center"
...
>
  ...
  X
                        ...
                        <p className="mt-1 text-sm text-gray-300">
                          Um projeto com base no Replicate, Microsoft e Meta.
                      </p>
                      </div>
                        ...
                        <div className="divide-y divide-gray-200 px-4 sm:px-6">
                          <div className="space-y-6 pb-5 pt-6">
                            <div>
                              ...
                              >
                                Tamanho maior significa mais inteligente, mas mais lento.
                              </p>
                              <div className="">
                          ...
                          <div className="space-y-6 pb-5 pt-6">
                            <div>
                              ...
                              <p
                                ...
                                className="mt-2 text-xs text-gray-500"
                              >
                                Isso é prepended ao prompt e ajuda a guiar o comportamento do sistema.
                              </p>
                              <div className="mt-3">
                                <textarea
                                  id="systemPrompt"
                          ...
                          <div className="space-y-6 pb-5 pt-6">
                            <div>
                              ...
                              >
                                Ajusta a aleatoriedade das saídas, maior que 1 é aleatório e 0 é determinístico, 0,75 é um bom valor inicial.
                              </p>
                              <div className="mt-3">
                                <input
                                  id="temperature"
                          ...
                          <div className="space-y-6 pb-5 pt-6">
                            <div>
                              ...
                              <p
                                ...
                                id="temperature-description"
                              >
                                Número máximo de tokens a gerar. Uma palavra é geralmente 2-3 tokens.
                              </p>
                              <div className="mt-3">
                                <input
                                  id="maxTokens"
                          ...
                          <div className="space-y-6 pb-5 pt-6">
                            <div>
                              ...
                              <p
                                ...
                                id="temperature-description"
                              >
                                Ao decodificar texto, amostras do topo p porcentagem dos tokens mais prováveis; menor para ignorar tokens menos prováveis.
                              </p>
                              <div className="mt-3">
                                <input
                                  id="topP"
